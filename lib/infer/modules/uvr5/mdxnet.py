...
class Predictor:
    ...
    def prediction(self, m, vocal_root, others_root, format):
        ...
        if format in ["wav", "flac"]:
            ...
            final_vocal_path = "%s/%s_main_vocal.%s" % (vocal_root, basename, format)
            final_instrument_path = "%s/%s_others.%s" % (others_root, basename, format)
        else:
            ...
            final_vocal_path = path_vocal
            final_instrument_path = path_other

        return final_vocal_path, final_instrument_path
